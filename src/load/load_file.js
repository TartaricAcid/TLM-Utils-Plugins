    ...
    let select = new Dialog({
            ...
            sidebar: {
                ...
                actions: [
                    ...
                    new Action("tlm_utils.load_pack.new", {
                        ...
                        click: function () {
                            ...
                            select.content_vue.newModelPack = true;
                        }
                    }),
                    new Action("tlm_utils.load_pack.delete", {
                        ...
                        icon: "fa-trash-alt",
                        click: function () {
                            if (isEmpty(select.sidebar.page)) {
                                return;
                            }
                            ...
                            if (index === 0 && page in pages) {
                                ...
                                electron.shell.trashItem(delPath).then(() => {
                                    ...
                                    if (pages && Object.keys(pages).length > 0) {
                                        select.sidebar.setPage(Object.keys(pages)[0]);
                                    } else {
                                        select.sidebar.setPage("");
                                    }
                                    select.sidebar.build();
                                });
                            }
                        }
                    }),
                ...
                onPageSwitch(page) {
                    ...
                    select.content_vue.newModelPack = false;
                    select.content_vue.newModelPackId = "";
                ...
                methods: {
                    ...
                    newModelPackIdConfirm: function () {
                        ...
                        if (pages && this.checkNewModelPackId()) {
                            ...
                            select.sidebar.setPage(this.newModelPackId);
                            select.sidebar.build();
                        }
                    },
